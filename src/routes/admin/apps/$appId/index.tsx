...
export const Route = createFileRoute("/admin/apps/$appId")({
  head: () => ({
    meta: [
      { title: "App Categories | Nexus Portal" },
      {
        name: "description",
        content: "Manage the categories that belong to this app inside Nexus Portal.",
      },
      { property: "og:title", content: "App Categories | Nexus Portal" },
